 ...
 * fileName to the hashcode of contents, which is used for the comparision of contents, i.e. the
...
class SmallTextFilesSuite extends FunSuite with BeforeAndAfterAll {
  ...
  override def beforeAll() {
    ...
    conf.set("dfs.datanode.data.dir.perm", SmallTextFilesSuite.dirPermission())
