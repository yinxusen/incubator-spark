 ...
 */
class SVMWithSGDAlt private (
    var stepSize: Double,
    var numIterations: Int,
    var regParam: Double,
    var miniBatchFraction: Double)
  extends GeneralizedLinearAlgorithm[SVMModelAlt] with Serializable {
  ...
  def createModel(weights: Array[Double], intercept: Double) = {
    new SVMModelAlt(weights, intercept)
  }
}
...
object SVMWithSGDAlt {
  ...
  def train(
    ...
    : SVMModelAlt =
  {
    new SVMWithSGDAlt(stepSize, numIterations, regParam, miniBatchFraction).run(input,
      initialWeights)
  }
